  ...
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-neutral-950",
  {
    variants: {
      side: {
        ...
        // Add top and bottom if needed, but for left side, we focus on left and right
      },
    },
    defaultVariants: {
...
// CSS Animations (if not already defined, add them in your CSS file)
// Define these in your global CSS file or Tailwind configuration
